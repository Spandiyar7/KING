...
export const metadata: Metadata = {
  title: "Контакты",
  description: "Контакты KING COLLECTION: WhatsApp, Instagram, email и форма заявки."
};
      ...
      <section className="bg-[#f8f8f7] py-20 text-[#3f3f3f] md:py-32">
        <div className="giorgio-container grid gap-14 lg:grid-cols-[0.72fr_1fr]">
          <div data-luxury-reveal>
            <p className="text-sm uppercase tracking-[0.18em] text-black/36">KING COLLECTION</p>
